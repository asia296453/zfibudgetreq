sap.ui.define([
    ...
    "zfibudgetreq/model/models"
], (UIComponent, models) => {
    "use strict";

    return UIComponent.extend("zfibudgetreq.Component", {
        metadata: {
            manifest: "json",
            interfaces: [
        ...
        init() {
            ...
            this.setModel(new sap.ui.model.json.JSONModel(), "Breqno");
            ...
            this.setModel(new sap.ui.model.json.JSONModel(), "FundsCenter");
            this.setModel(new sap.ui.model.json.JSONModel(), "CommitmentItem");
            // enable routing
